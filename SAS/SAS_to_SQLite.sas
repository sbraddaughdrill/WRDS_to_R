...
*=====================================================================;
*%include "C:\Users\bdaughdr\Dropbox\Research_Methods\SAS\Macros\Brad\DeleteMacros.sas"; *Office;
*%include "\\tsclient\C\Users\bdaughdr\Dropbox\Research_Methods\SAS\Macros\Brad\DeleteMacros.sas"; *CoralSea from Office;
%include "\\tsclient\F\Dropbox\Research_Methods\SAS\Macros\Brad\DeleteMacros.sas";  *CoralSea from Home;
%DeleteMacros;
*=====================================================================;
*Create Macro Directory;
*=====================================================================;
%global fullmacrodirectory;
*%let fullmacrodirectory=C:\Users\bdaughdr\Dropbox\Research_Methods\SAS\Macros; *Office;
*%let fullmacrodirectory=\\tsclient\C\Users\bdaughdr\Dropbox\Research_Methods\SAS\Macros; *CoralSea from Office;
%let fullmacrodirectory=\\tsclient\F\Dropbox\Research_Methods\SAS\Macros;  *CoralSea from Home;
*=====================================================================;
*Create Local Directories;
*=====================================================================;
*%symdel projectrootdirectory;
%global projectrootdirectory;
*%let projectrootdirectory=C:\Users\bdaughdr\Dropbox\Research_Methods\3rd-Year_Paper\SAS; *CoralSea from Office;
%let projectrootdirectory=\\tsclient\F\GitHub\WRDS_to_R\SAS;  *CoralSea from Home;
*=====================================================================;
*Macro includes;
*=====================================================================;
...
libname &crspadatalibrary. "H:\Research\Import_Data\Data\CRSP_A";
%let crspmfdatalibrary=crspmf;
libname &crspmfdatalibrary. "H:\Research\Import_Data\Data\CRSP_Q";
%let trdatalibrary=tr;
libname &trdatalibrary. "H:\Research\Import_Data\Data\TR_MF";
%let mflinksdatalibrary=mflinks;
libname &mflinksdatalibrary. "H:\Research\Import_Data\Data\MFLinks";
%let msddatalibrary=msd;
libname &msddatalibrary. "H:\Research\Import_Data\Data\Morningstar_Direct";
%let secdatalibrary=sec;
libname &secdatalibrary. "H:\Research\Import_Data\Data\SEC_Analytics";
%let textdatalibrary=text;
libname &secdatalibrary. "H:\Research\Import_Data\Data\Text_Analysis";
*********************************************************************************;
*STEP 0: MOVE SAS DATA TO WORK DATA LIBRARY;
*********************************************************************************;
data Crspa_msi;
  *set &crspadatalibrary..Crspa_msi;
  set &crspadatalibrary..Msi;
run;
data Daily_returns;
...
*********************************************************************************;
%global projectoutdirectory;
*%let projectoutdirectory=C:\Users\bdaughdr\Documents\temp_out; *CoralSea from Office;
%let projectoutdirectory=C:\Users\bdaughdr\Documents\temp_out; *CoralSea from Home;

proc export data=Crspa_msi outfile= "&projectoutdirectory.\Crspa_msi.csv" DBMS=CSV REPLACE;
run;
proc export data=Daily_returns outfile= "&projectoutdirectory.\Daily_returns.csv" DBMS=CSV REPLACE;
run;
proc export data=Fund_fees outfile= "&projectoutdirectory.\Fund_fees.csv" DBMS=CSV REPLACE;
run;
proc export data=Fund_hdr outfile= "&projectoutdirectory.\Fund_hdr.csv" DBMS=CSV REPLACE;
run;
proc export data=Fund_hdr_hist outfile= "&projectoutdirectory.\Fund_hdr_hist.csv" DBMS=CSV REPLACE;
run;
proc export data=Fund_names outfile= "&projectoutdirectory.\Fund_names.csv" DBMS=CSV REPLACE;
run;
proc export data=Fund_style outfile= "&projectoutdirectory.\Fund_style.csv" DBMS=CSV REPLACE;
run;
proc export data=Fund_summary outfile= "&projectoutdirectory.\Fund_summary.csv" DBMS=CSV REPLACE;
run;
proc export data=Fund_summary2 outfile= "&projectoutdirectory.\Fund_summary2.csv" DBMS=CSV REPLACE;
run;
proc export data=Monthly_tna_ret_nav outfile= "&projectoutdirectory.\Monthly_tna_ret_nav.csv" DBMS=CSV REPLACE;
run;
proc export data=Mdmf_data_raw outfile= "&projectoutdirectory.\Mdmf_data_raw.csv" DBMS=CSV REPLACE;
run;

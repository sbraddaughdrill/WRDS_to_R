...
crsp_in_db <- paste(output_directory,"CRSPMF.s3db",sep="")
...
{
  Crspa_msi[,Crspa_msi_num_to_date_cols[i]] <- as.character(as.Date(as.integer(Crspa_msi[,Crspa_msi_num_to_date_cols[i]]), origin="1960-01-01"))
...
rm2(Crspa_msi_num_to_date_cols,Crspa_msi)
...
rm2(Daily_returns_num_to_pad_cols,Daily_returns_num_to_date_cols,Daily_returns)
...
rm2(Fund_fees_num_to_pad_cols,Fund_fees_num_to_date_cols,Fund_fees)
...
rm2(Fund_hdr_num_to_pad_cols,Fund_hdr_num_to_char_cols,Fund_hdr_num_to_date_cols,Fund_hdr)
...
rm2(Fund_hdr_hist_num_to_pad_cols,Fund_hdr_hist_num_to_char_cols,Fund_hdr_hist_num_to_date_cols,Fund_hdr_hist)
...
{
  Fund_names[,Fund_names_num_to_date_cols[i]] <- as.character(as.Date(as.integer(Fund_names[,Fund_names_num_to_date_cols[i]]), origin="1960-01-01"))
...
rm2(Fund_names_num_to_pad_cols,Fund_names_num_to_char_cols,Fund_names_num_to_date_cols,Fund_names)
...
rm2(Fund_style_num_to_pad_cols,Fund_style_num_to_date_cols,Fund_style)
...
rm2(Fund_summary_num_to_pad_cols,Fund_summary_num_to_date_cols,Fund_summary)
...
rm2(Fund_summary2_num_to_pad_cols,Fund_summary2_num_to_date_cols,Fund_summary2)
...
rm2(Monthly_tna_ret_nav_num_to_pad_cols,Monthly_tna_ret_nav_num_to_date_cols,Monthly_tna_ret_nav)
